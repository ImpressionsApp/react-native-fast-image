                 ...
                 rejecter:(RCTPromiseRejectBlock)reject)
{
    ...
    [[SDWebImagePrefetcher sharedImagePrefetcher] prefetchURLs:urls progress:nil completed:^(NSUInteger finishedCount, NSUInteger skippedCount) { resolve(@{ @"finishedCount": @(finishedCount), @"skippedCount": @(skippedCount) }); }];
}
